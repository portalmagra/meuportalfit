...
export default function HomensPage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            product.category === 'homens' || 
            product.category === 'Saúde Masculina' ||
            product.category === 'homens'
          )
  ...
  const content = {
    pt: {
      ...
      subtitle: 'Suplementos específicos para homens',
      description: 'Produtos desenvolvidos especialmente para as necessidades de saúde dos homens.',
