...
export default function ImunidadePage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            product.category === 'imunidade' || 
            product.category === 'Imunidade e Defesa' ||
            product.category === 'imunidade'
          )
  ...
  const content = {
    pt: {
      ...
      subtitle: 'Fortalecimento do sistema imunológico',
      description: 'Suplementos para fortalecer suas defesas naturais e manter a saúde.',
