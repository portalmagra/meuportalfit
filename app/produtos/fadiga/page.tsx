...
export default function FadigaPage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            product.category === 'fadiga' || 
            product.category === 'Fadiga e Energia' ||
            product.category === 'fadiga'
          )
  ...
  const content = {
    pt: {
      title: 'Fadiga e Energia',
      subtitle: 'Suplementos para vitalidade e disposição',
      description: 'Produtos naturais para combater a fadiga e aumentar sua energia diária.',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      {/* Hero Section */}
      <section style={{
        background: 'linear-gradient(135deg, #f0f9ff 0%, #f8fafc 50%, #e2e8f0 100%)',
        padding: '2rem 1rem',
        textAlign: 'center',
        color: '#1f2937'
      }}>
