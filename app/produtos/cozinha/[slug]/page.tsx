...
export default function CozinhaProductPage({ params }: { params: { slug: string } }) {
    ...
    const loadProduct = () => {
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = allProducts.filter((p: Product) => p.categoryId === 'cozinha')
  ...
  if (!product) {
    return (
      <div style={{ textAlign: 'center', padding: '3rem 0' }}>
        ...
        <Link href="/produtos/cozinha" style={{ textDecoration: 'none' }}>
          <button style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Link href="/produtos/cozinha" style={{ textDecoration: 'none', flex: 1 }}>
                    <button style={{
                      width: '100%',
                      padding: '0.8rem',
                      background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
