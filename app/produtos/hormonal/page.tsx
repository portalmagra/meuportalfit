...
export default function HormonalPage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            ...
            product.category === 'Equilíbrio Hormonal' ||
            product.category === 'hormonal'
          )
  ...
  const content = {
    pt: {
      ...
      subtitle: 'Suplementos para equilibrar seus hormônios',
      description: 'Produtos naturais para manter o equilíbrio hormonal e bem-estar geral.',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      {/* Hero Section */}
      <section style={{
        background: 'linear-gradient(135deg, #fdf4ff 0%, #f8fafc 50%, #e2e8f0 100%)',
        padding: '2rem 1rem',
        textAlign: 'center',
        color: '#1f2937'
      }}>
