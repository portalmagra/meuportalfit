...
export default function ShotAfrodisiacoProductPage({ params }: { params: { slug: string } }) {
    ...
    const loadProduct = () => {
      try {
        ...
        if (storedProducts) {
          ...
          const shotProducts = allProducts.filter((p: Product) => p.categoryId === 'shot-afrodisiaco')
          
          // Encontrar o produto pelo slug
          const foundProduct = shotProducts.find((p: Product) => {
  ...
  if (!product) {
    return (
      <div style={{ textAlign: 'center', padding: '3rem 0' }}>
        ...
        <Link href="/produtos/shot-afrodisiaco" style={{ textDecoration: 'none' }}>
          <button style={{
            ...
            ← Voltar à Categoria Shot Afrodisíaco
          </button>
        </Link>
      </div>
    )
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Link href="/produtos/shot-afrodisiaco" style={{ textDecoration: 'none', flex: 1 }}>
                    <button style={{
                      width: '100%',
                      padding: '0.8rem',
                      background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
