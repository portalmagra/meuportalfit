...
export default function ImunidadeProductPage({ params }: { params: { slug: string } }) {
    ...
    const loadProduct = () => {
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = allProducts.filter((p: Product) => p.categoryId === 'imunidade')
  ...
  if (!product) {
    return (
      <div style={{ textAlign: 'center', padding: '3rem 0' }}>
        ...
        <Link href="/produtos/imunidade" style={{ textDecoration: 'none' }}>
          <button style={{
  ...
  return (
    <>
      <main style={{ padding: '0', background: 'white' }}>
        ...
        {/* Hero Section */}
        <section style={{
          background: 'linear-gradient(135deg, #98D8C8, #10B981)',
          padding: '2rem 0',
          textAlign: 'center'
        }}>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Link href="/produtos/imunidade" style={{ textDecoration: 'none', flex: 1 }}>
                    <button style={{
                      width: '100%',
                      padding: '0.8rem',
                      background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
