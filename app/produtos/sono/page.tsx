...
export default function SonoPage() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      // Filtrar apenas produtos da categoria 'sono'
      const categoryProducts = products.filter((p: Product) => p.categoryId === 'sono');
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.2rem', marginBottom: '30px', opacity: 0.9 }}>
            Produtos selecionados para melhorar o sono e descanso naturalmente
          </p>
        ...
        {adminProducts.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#666', marginBottom: '30px', fontSize: '1.1rem' }}>
              Nossos especialistas estão selecionando produtos específicos para melhorar a qualidade do sono.
            </p>
            <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/analise" style={{
                padding: '15px 30px',
          ...
          <div>
            <h2 style={{ color: '#333', marginBottom: '30px', textAlign: 'center' }}>
              😴 Produtos Selecionados para Qualidade do Sono
            </h2>
