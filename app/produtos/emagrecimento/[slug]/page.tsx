...
export default function EmagrecimentoProductPage({ params }: { params: { slug: string } }) {
    ...
    const loadProduct = () => {
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = allProducts.filter((p: Product) => p.categoryId === 'emagrecimento')
  ...
  if (!product) {
    return (
      <div style={{ textAlign: 'center', padding: '3rem 0' }}>
        ...
        <Link href="/produtos/emagrecimento" style={{ textDecoration: 'none' }}>
          <button style={{
            ...
            ← Voltar à Categoria Emagrecimento
          </button>
        </Link>
      </div>
    )
  ...
  return (
    <>
      <main style={{ padding: '0', background: 'white' }}>
        ...
        {/* Hero Section */}
        <section style={{
          background: 'linear-gradient(135deg, #96CEB4, #22C55E)',
          padding: '2rem 0',
          textAlign: 'center'
        }}>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Link href="/produtos/emagrecimento" style={{ textDecoration: 'none', flex: 1 }}>
                    <button style={{
                      width: '100%',
                      padding: '0.8rem',
                      background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
