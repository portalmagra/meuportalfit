...
export default function SonoPage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            product.category === 'sono' || 
            product.category === 'Qualidade do Sono' ||
            product.category === 'sono'
          )
  ...
  const content = {
    pt: {
      ...
      subtitle: 'Suplementos para um sono reparador',
      description: 'Produtos naturais para melhorar a qualidade do seu sono e descanso.',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      {/* Hero Section */}
      <section style={{
        background: 'linear-gradient(135deg, #f8fafc 0%, #f8fafc 50%, #e2e8f0 100%)',
        padding: '2rem 1rem',
        textAlign: 'center',
        color: '#1f2937'
      }}>
