...
export default function CozinhaPage() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      // Filtrar apenas produtos da categoria 'cozinha'
      const categoryProducts = products.filter((p: Product) => p.categoryId === 'cozinha');
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '20px', fontWeight: 'bold' }}>
            🍳 Produtos para Cozinha Saudável
          </h1>
          <p style={{ fontSize: '1.2rem', marginBottom: '30px', opacity: 0.9 }}>
            Produtos selecionados para uma cozinha mais saudável e funcional
          </p>
        ...
        {adminProducts.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#666', marginBottom: '30px', fontSize: '1.1rem' }}>
              Nossos especialistas estão selecionando produtos específicos para cozinha saudável.
            </p>
            <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/analise" style={{
                padding: '15px 30px',
          ...
          <div>
            <h2 style={{ color: '#333', marginBottom: '30px', textAlign: 'center' }}>
              🍳 Produtos Selecionados para Cozinha Saudável
            </h2>
