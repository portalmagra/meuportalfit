...
export default function CozinhaPage() {
      ...
      try {
        ...
        if (storedProducts) {
          ...
          const categoryProducts = products.filter((product: any) => 
            ...
            product.category === 'Cozinha Saudável' ||
            product.category === 'cozinha'
          )
  ...
  const content = {
    pt: {
      ...
      subtitle: 'Utensílios e ingredientes para uma alimentação melhor',
      description: 'Equipamentos e ingredientes essenciais para preparar refeições nutritivas e deliciosas.',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      {/* Hero Section */}
      <section style={{
        background: 'linear-gradient(135deg, #fef3c7 0%, #f8fafc 50%, #e2e8f0 100%)',
        padding: '2rem 1rem',
        textAlign: 'center',
        color: '#1f2937'
      }}>
